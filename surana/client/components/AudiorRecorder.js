...
const imagePaths = {
  ...
  Random: require('/Users/yugamsurana/Desktop/omg/language/src/components/images/movies.gif')
};
...
const AudioRecorder = () => {
  ...
  const questions = questionsMap.get(route.params?.category) || [];
  ...
  async function stopRecording() {
    ...
    if (currentQuestionIndex < questions.length - 1) {
      ...
      console.log(questions[currentQuestionIndex + 1][0]);
      console.log(questions[currentQuestionIndex + 1][1]);
      await speak(questions[currentQuestionIndex + 1][0]);
  ...
  async function repeatQuestion() {
    if (currentQuestionIndex < questions.length) {
      ...
      await speak(questions[currentQuestionIndex][0]);
      setCountdown(3);
    }
  }
  ...
  return (
    <LinearGradient
      colors={['#480000','#200000', 'black', 'black']}
      style={styles.gradientContainer}
    >
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.imageContainer}>
          <Image
            source={imagePaths[route.params?.category] || imagePaths.Food}
    ...
    <TouchableOpacity
        onPress={() => {
          console.log('Pressed');
          Alert.alert('Clue', questions[currentQuestionIndex][0]);
                }}
